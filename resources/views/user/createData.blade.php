...
<div class="register-box">
    <div class="card card-outline card-danger">
      ...
      <img src="/img/logo.png" alt="logo" width="80px">
        <a href="/" class="h1"><b>Lengkapi</b>Data</a>
      </div>
      <div class="card-body">
        <p class="login-box-msg">Lengkapi Datamu</p>

        <form action="/createDataProses36" method="post" enctype="multipart/form-data">
            @csrf
        ...
        <div class="social-auth-links text-center">
          <a href="/profile36" class="btn btn-block btn-danger">
            Kembali
          </a>
        </div>
      </div>
